          ...
          dashData.latestAppointments.map((item,index)=>(
            <div key={index} className='flex items-center px-6 py-3 gap-3 hover:bg-gray-100'>
             ...
             <div className='flex-1 text-sm'>
              ...
              {
                item.cancelled
                  ? <p className='text-red-400 font-medium ml-4'>Cancelled</p>
                  : <img onClick={()=>cancelAppointment(item._id)} className='w-10 cursor-pointer ml-4'  src={assets.cancel_icon} alt="Cancel" />
              }
            </div>
          ))
         }
